...
import net.biot.domain.Authority;
import net.biot.domain.User;
import net.biot.repository.AuthorityRepository;
...
import net.biot.web.rest.errors.ExceptionTranslator;
import net.biot.web.rest.vm.KeyAndPasswordVM;
import net.biot.web.rest.vm.ManagedUserVM;
