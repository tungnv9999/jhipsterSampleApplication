package net.biot.repository;

import net.biot.JhipsterSampleApplicationApp;
import net.biot.config.Constants;
import net.biot.config.audit.AuditEventConverter;
import net.biot.domain.PersistentAuditEvent;
...
import static net.biot.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
